# PosturePal v2 + Desktop Companion with Dynamic Expressions ("udang_nrml.png", "udang_fwrd.png", "udang_bckwrd.png")
...
class DesktopPetWidget(QWidget):
    def __init__(self):
        ...
        self.pixmaps = {}
        image_files = {
            'Normal': 'udang_normal.png',
            'Forward': 'udang_forward.png',
            'Back': 'udang_backward.png'
        }
